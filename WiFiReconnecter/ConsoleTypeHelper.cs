...
namespace WiFiReconnecter
{
    ...
    {
        public static string GetConsoleTypeString(this ConsoleType ct)
        {
            ...
            switch(ct)
            {
                ...
                case ConsoleType.WiFiConnected: r = $"{ots}: WiFi is connected!"; break;
                case ConsoleType.WiFiReconnected: r = $"{ots}: WiFi reconnected"; break;
